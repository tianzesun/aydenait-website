    ...
    <nav className="sticky top-0 z-40 bg-white border-b shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-5 px-4">
        ...
        <ul className="hidden md:flex gap-8 font-semibold items-center text-base">
          ...
          <li><Link to="/why-us" className="relative hover:text-blue-600 text-gray-800 transition-all duration-200 after:content-[''] after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-blue-600 after:transition-all after:duration-200 hover:after:w-full">Why Us</Link></li>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t">
          <ul className="flex flex-col py-5 px-4 space-y-4">
            ...
            <li><Link to="/why-us" className="block hover:text-blue-600 text-gray-800 font-semibold text-base transition-all hover:translate-x-2 hover:bg-blue-50 p-2 rounded-lg" onClick={() => setIsMenuOpen(false)}>Why Us</Link></li>
