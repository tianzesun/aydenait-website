      ...
      <div className="bg-white/10 rounded-2xl p-8 shadow-lg flex flex-col justify-center">
        ...
        <form className="flex flex-col gap-4">
          <div>
            ...
            <input type="text" required className="w-full border-b bg-transparent px-3 py-2 text-blue-100 border-blue-400 rounded focus:outline-none focus:border-cyan-400 transition"/>
          </div>
          <div>
            <label className="block mb-1 font-semibold text-blue-200">Email<span className="text-red-500">*</span></label>
            <input type="email" required className="w-full border-b bg-transparent px-3 py-2 text-blue-100 border-blue-400 rounded focus:outline-none focus:border-cyan-400 transition"/>
          </div>
          <div>
            <label className="block mb-1 font-semibold text-blue-200">Phone</label>
            <input type="tel" className="w-full border-b bg-transparent px-3 py-2 text-blue-100 border-blue-400 rounded focus:outline-none focus:border-cyan-400 transition"/>
          </div>
          <div>
            <label className="block mb-1 font-semibold text-blue-200">Message</label>
            <textarea rows={5} required className="w-full border-b bg-transparent px-3 py-2 text-blue-100 border-blue-400 rounded focus:outline-none focus:border-cyan-400 transition"></textarea>
          </div>
      ...
      <div className="flex flex-col gap-8 justify-center">
        ...
        <div className="bg-white/5 rounded-xl px-6 py-6 text-blue-100">
          ...
          <div className="flex gap-4 mb-3">
            <a href="https://linkedin.com/" className="hover:text-cyan-300 underline">LinkedIn</a>
            <a href="https://twitter.com/" className="hover:text-cyan-300 underline">Twitter</a>
          </div>
